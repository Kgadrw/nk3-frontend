...
const Banner = () => {
  ...
  return (
    <section className="relative w-full min-h-[300px] md:min-h-[350px] grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="relative min-h-[300px] md:min-h-[350px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-10 md:px-20 lg:px-24 xl:px-28 py-6 md:py-8">
          <p className="text-[#90EE90] text-xs md:text-sm font-medium uppercase tracking-wide mb-4">
            WHY CHOOSE US?
          </p>
      ...
      <div className="relative min-h-[300px] md:min-h-[350px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-6 md:px-12 py-6 md:py-8">
          <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-[#009f3b] leading-tight mb-2 min-h-[1.2em]">
            <TypingText text="Bringing Your Ideas" delay={80} />
          </h2>
          <h3 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-[#009f3b] leading-tight mb-8 min-h-[1.2em]">
